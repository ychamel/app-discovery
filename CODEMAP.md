...
- `DesignSystemEnumerationTests` — enumeration guard asserting referenced CSS tokens/classes ⊆ defined — `apps/core/tests/test_design_system.py`
...
- `{% icon "<name>" %}` — new reusable tag rendering an inline SVG icon, failing loud on unknown name — `apps/core/templatetags/icons.py`
