...
| `BUG-001` | Bug | 2026-06-28 | Developer / QA Team | Interest picker duplicate subcategories label click highlights previous occurrence | Medium | `IN-PROGRESS` | [`BUG-001.md`](BUG-001.md) | [`features/patch-interest-picker-duplicates/`](../features/patch-interest-picker-duplicates/) |
