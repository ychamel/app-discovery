...
| `BUG-002` | Bug | 2026-06-28 | User / Developer | Profile display name update fails with 405 Method Not Allowed and idles | High | `IN-PROGRESS` | [`BUG-002.md`](BUG-002.md) | [`features/patch-profile-form-actions/`](../features/patch-profile-form-actions/) — Patch Track (server-rendered form handlers; also fixes the delete-account form, same root cause) |
