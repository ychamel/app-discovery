...
| `Q-002` | Question | 2026-06-29 | User | Should a user be able to submit a review for their own app? | Medium | `RESOLVED` | [`Q-002.md`](Q-002.md) | **Answered Option A — block self-review** (DN-Q002) → [`patches/patch-block-self-interaction/`](../patches/patch-block-self-interaction/) — closed-out (released local/dev): service guard (`SelfRatingError`) + view mapping + slot notice; 1013 tests |
| `Q-003` | Question | 2026-06-29 | User | Should a user be able to follow their own app? | Low | `RESOLVED` | [`Q-003.md`](Q-003.md) | **Answered Option A — block self-follow** (DN-Q003) → [`patches/patch-block-self-interaction/`](../patches/patch-block-self-interaction/) — closed-out (released local/dev): service guard (`SelfFollowError`) + view mapping + slot hide; 1013 tests |
