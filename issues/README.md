...
| `UX-004` | UX | 2026-06-29 | User | "My Submissions" label is misleading after approval; no status-based grouping or tags | Medium | `IN-PROGRESS` | [`UX-004.md`](UX-004.md) | [`features/patch-my-apps-status-display/`](../features/patch-my-apps-status-display/) — bundled with UX-006 (same template); Patch Track |
...
| `UX-006` | UX | 2026-06-29 | User | No direct link from "My Submissions" to the public app page post-approval | Medium | `IN-PROGRESS` | [`UX-006.md`](UX-006.md) | [`features/patch-my-apps-status-display/`](../features/patch-my-apps-status-display/) — bundled with UX-004 (same template); Patch Track |
