...
|------|--------------|-------|---------|------------------|
| [patch-block-self-interaction](patch-block-self-interaction/) | [`Q-002`](../issues/Q-002.md) (Medium) + [`Q-003`](../issues/Q-003.md) (Low) | `P-plan` | 2026-06-29 | _in progress_ — block self-review (Q-002, Option A) + self-follow (Q-003, Option A): owner guard suppresses the app-page control and rejects the mutation server-side; owner identity already on the `CatalogApp` DTO (no schema). |
