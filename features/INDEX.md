...
| [developer-dashboard](developer-dashboard/) | 3 Dev value | `1-define` | 2026-06-23 | H2 | signal-capture, ratings-reviews | _**active** — Phase-3 core developer value: a read-only view of an app's reception (reach/engagement from D-7 signals + incoming D-8 curated ratings) for the person who cares most. Stage `1-define` — [FEATURE_BRIEF.md](developer-dashboard/FEATURE_BRIEF.md) **drafted, awaiting approval (DN-19)**; reuses D-3/D-5/D-6/D-7/D-8, no new ADR_ |
