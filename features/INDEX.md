...
| [open-search-browse](open-search-browse/) | 2 User loop | `2-design` | 2026-06-23 | enabler / H3 | app-pages | _**active** — Phase-2 open discovery surface: browse / keyword-search / interest-filter the D-6 accepted-app catalogue → app-page, **money never buys position** (vision §4.1). [FEATURE_BRIEF.md](open-search-browse/FEATURE_BRIEF.md) **APPROVED** (DN-17; 6 stories / 9 ACs / 6 metrics; money-buys-position PASS; tag-filtering in MVP per OQ-OSB-1, order = newest-accepted / keyword-relevance per OQ-OSB-2). Handed to **Software Architect** to draft DESIGN.md_ |
