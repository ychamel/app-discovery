...
| [interest-profile](interest-profile/) | 2 User loop | `2-design` | 2026-06-21 | H1 | identity-accounts, interest-taxonomy | _**active** — Phase-2 personalization substrate: users declare interest-taxonomy tags, the user side of the Ring-0 match (H1). Brief **approved (DN-15)** — tags-only + optional onboarding; reuses D-3/D-5, no new global decision. Software Architect drafting [DESIGN.md](interest-profile/DESIGN.md)_ |
