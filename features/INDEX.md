...
| [app-pages](app-pages/) | 1 Catalog | `1-define` | 2026-06-19 | H1, H2 | submission-intake | _active — FEATURE_BRIEF.md drafted (uniform openly-accessible public page per accepted app; 6 stories/9 ACs); awaiting approval (DN-9)_ |
