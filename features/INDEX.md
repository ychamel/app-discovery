...
| [app-pages](app-pages/) | 1 Catalog | `2-design` | 2026-06-20 | H1, H2 | submission-intake | _active — brief approved (DN-9); DESIGN.md drafted (new app `apps/pages/`, pure D-6/D-7 consumer, no model; page-view = `app_page` impression resolves OQ-2; AP-3/4/5); awaiting approval (DN-10)_ |
