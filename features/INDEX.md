...
| [submission-intake](submission-intake/) | 1 Catalog | `6-post-release` | 2026-06-17 | H2 | identity-accounts, interest-taxonomy | _released local/dev (apps/catalog, 315 tests green; rollout→rollback rehearsed); established global D-6 catalogued-app contract; awaiting Stage-6 run-now-vs-skip (DN-3)_ |
