...
| [open-search-browse](open-search-browse/) | 2 User loop | `1-define` | 2026-06-23 | enabler / H3 | app-pages | _**active** — Phase-2 open discovery surface: search/browse the D-6 accepted-app catalogue, the surface where money never buys position (vision §4.1). Product Analyst drafting [FEATURE_BRIEF.md](open-search-browse/FEATURE_BRIEF.md)_ |
