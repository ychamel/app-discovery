...
| [open-search-browse](open-search-browse/) | 2 User loop | `1-define` | 2026-06-23 | enabler / H3 | app-pages | _**active** — Phase-2 open discovery surface: browse / keyword-search / interest-filter the D-6 accepted-app catalogue → app-page, **money never buys position** (vision §4.1). Product Analyst drafted [FEATURE_BRIEF.md](open-search-browse/FEATURE_BRIEF.md) (6 stories / 9 ACs / 6 metrics; money-buys-position PASS) — **awaiting DN-17** (approve + filtering-in-MVP + default order)_ |
